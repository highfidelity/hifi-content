...
declare namespace Agent {
  ...
  function stop(): void;
  function sendStatsPacket(): void;
  function clearQueuedCheckIns(): void;
  /**
   * @returns {Signal} 
   */
  function finished(): Signal;
  function domainSettingsRequestFailed(): void;
...
declare namespace LODManager {
   ...
   * @param value {number}  
   */
  function setDesktopLODDecreaseFPS(value: number): void;
  /**
   * @returns {number} 
   */
  function getDesktopLODDecreaseFPS(): number;
  /**
   * @returns {number} 
   */
  function getDesktopLODIncreaseFPS(): number;
  /**
   * @param value {number}  
   */
  function setHMDLODDecreaseFPS(value: number): void;
  /**
   * @returns {number} 
   */
  function getHMDLODDecreaseFPS(): number;
  /**
   * @returns {number} 
   */
  function getHMDLODIncreaseFPS(): number;
  /**
   * @returns {string} 
   */
   ...
   * @returns {number} 
   */
  function getLODDecreaseFPS(): number;
  /**
   * @returns {number} 
   */
  function getLODIncreaseFPS(): number;
  /**
   * @returns {Signal} 
   */
...
for the specified role, this function will have no effect.
   ...
   * @returns {boolean} 
   */
  function getClearOverlayWhenMoving(): boolean;
  /**
   * @returns {boolean} 
   */
  function setClearOverlayWhenMoving(): boolean;
  /**
   * @param hand {string}  
   */
...
false and any pose values returned will not be meaningful.
   ...
   */
  function goToLocation(position: Vec3, hasOrientation: boolean, orientation: Quat, shouldFaceLocation: boolean): void;
  /**
...
in the avatar's model file. Typically this is a T-pose.
   ...
   * @returns {Vec3} 
   */
  function getLeftPalmRotation(): Vec3;
  /**
   ...
   * @returns {Vec3} 
   */
  function getRightPalmRotation(): Vec3;
  /**
   * @returns {Signal} 
   */
  ...
  /**
   * Returns the value of the Interface setting, Settings > Advanced 
...
declare namespace Picks {
  interface RayPickProperties {
      ...
      maxDistance: float;
      /**
       * Only for Joint or Mouse Ray Picks.  If "Mouse", it will create a Ray Pick that follows the system mouse, in desktop or HMD.
...
declare namespace Pointers {
  ...
  interface LaserPointerProperties {
      /**
       * Ray Pointers only.  If true, the end of the Pointer will always rotate to face the avatar.
       */
      faceAvatar: boolean;
      /**
       * Ray Pointers only.  If false, the end of the Pointer will be moved up by half of its height.
       */
      centerEndY: boolean;
      /**
       * Ray Pointers only.  If true, the end of the Pointer will lock on to the center of the object at which the laser is pointing.
       */
      lockEnd: boolean;
      /**
       * Ray Pointers only.  If true, the dimensions of the end of the Pointer will scale linearly with distance.
       */
      distanceScaleEnd: boolean;
      /**
       * Ray Pointers only.  If true, the width of the Pointer's path will scale linearly with your avatar's scale.
       */
...
with PickType.Ray, depending on which optional parameters you pass, you could create a Static Ray Pointer, a Mouse Ray Pointer, or a Joint Ray Pointer.
   ...
   * @param uid {number}  The ID of the Pointer, as returned by {@link Pointers.createPointer}.
   * @param length {float}  The desired length of the Pointer.
   */
  function setLength(uid: number, length: float): void;
  /**
...
/**
* Available in:Interface ScriptsClient Entity ScriptsServer Entity ScriptsAssignment Client ScriptsThe Audio API features tools to help control audio contexts and settings.
*/
declare namespace Audio {
   ...
   * @param isHMD {boolean}  
   */
  function setInputDevice(device, isHMD: boolean): void;
  /**
   * @param device {}  
   * @param isHMD {boolean}  
   */
  function setOutputDevice(device, isHMD: boolean): void;
  /**
   * @param enable {boolean}  
   */
  function setReverb(enable: boolean): void;
  /**
   * @param options {AudioEffectOptions}  
   */
   ...
   * @returns {Signal} 
   */
  function onContextChanged(): Signal;
  /**
   * @param sound {}  
   * @param injectorOptions {} [injectorOptions=null] 
   * @returns {object} 
   */
  function playSound(sound, injectorOptions): object;
  /**
   * @param sound {}  
   * @param position {}  
   * @returns {object} 
   */
  function playSystemSound(sound, position): object;
  /**
   * @param stereo {boolean}  
   * @returns {boolean} 
   */
  function setStereoInput(stereo: boolean): boolean;
  /**
   * @returns {boolean} 
   */
   ...
   * @returns {Signal} 
   */
  function inputReceived(inputSamples): Signal;
  let muted: boolean;
...
Controller and Action Values
 ...
 Controller.getButtonValue for a particular device
 Controller.getAxisValue(0) for a particular device
 Controller.getPoseValue(0) for a particular device
...
declare namespace Controller {
   ...
   * @param source {StandardButtonChannel}  The button to get the value of.
   * @param device {number} [device=0] The ID of the hardware device to get the value from. The default value of 
   *    <code>0</code> corresponds to <code>Standard</code>.
   * @returns {number} 
   */
  function getButtonValue(source: StandardButtonChannel, device: number): number;
  /**
   * Get the value of an axis control on a particular device.
   * @param source {StandardAxisChannel}  The axis to get the value of.
   * @param device {number} [device=0] The ID of the hardware device to get the value from. The default value of 
   *    <code>0</code> corresponds to <code>Standard</code>.
   * @returns {number} 
   */
  function getAxisValue(source: StandardAxisChannel, device: number): number;
  /**
   * Get the value of an pose control on a particular device.
   * @param source {StandardPoseChannel}  The pose to get the value of.
   * @param device {number} [device=0] The ID of the hardware device to get the value from. The default value of 
   *    <code>0</code> corresponds to <code>Standard</code>.
   * @returns {Pose} 
   */
  function getPoseValue(source: StandardPoseChannel, device: number): Pose;
  /**
...
var filename = QString();
   */
  function takeSecondaryCameraSnapshot(filename: string): void;
  /**
...
declare namespace Overlays {
  ...
  used.)
      ...
      /**
       * If true,
       *      Overlays.findRayIntersection ignores the overlay.
       */
      ignoreRayIntersection: boolean;
      /**
   ...
   * @returns {boolean} 
   */
  function isAddedOverly(overlayID: Uuid): boolean;
  /**
...
declare namespace AnimationCache {
   ...
   * @returns {Resource} 
   */
  function prefetch(url: string, extra: object): Resource;
  /**
   * Asynchronously loads a resource from the specified URL and returns it.
   * @param url {string}  URL of the resource to load.
   * @param fallback {string} [fallback=""] Fallback URL if load of the desired URL fails.
   * @param extra {} [extra=null] 
   * @returns {Resource} 
   */
  function getResource(url: string, fallback: string, extra): Resource;
  /**
   * Returns animation resource for particular animation.
   * @param url {string}  URL to load.
   * @returns {Resource} 
   */
  function getAnimation(url: string): Resource;
  /**
...
/**
* Available in:Interface ScriptsClient Entity ScriptsServer Entity ScriptsAssignment Client Scripts
* @param reverbOptions {AudioEffectOptions.ReverbOptions} [reverbOptions=null] 
*/
...
declare namespace SoundCache {
   ...
   * @returns {object} 
   */
  function getSound(url: string): object;
  /**
   * Total number of total resources. Read-only.
   */
  let numTotal: number;
...
declare namespace Entities {
  ...
  The value can also be set at entity creation by using the clientOnly parameter in 
   Entities.addEntity.
      ...
      visible: boolean;
      /**
       * Whether or not the entity casts shadows. Currently applicable only to 
  ...
  emitted from the portion of the ellipsoid that lies between azimuthStart and azimuthFinish.
      ...
      /**
       * The radius of each particle at the start of its life. If not explicitly set, the 
       *     particleRadius value is used.
       */
      radiusStart: number;
      /**
       * The radius of each particle at the end of its life. If not explicitly set, the 
       *     particleRadius value is used.
       */
      radiusFinish: number;
      /**
      ...
      color: Color;
      /**
       * The color of each particle at the start of its life. If not explicitly set, the 
       *     color value is used.
       */
      colorStart: Color;
      /**
       * The color of each particle at the end of its life. If not explicitly set, the 
       *     color value is used.
       */
      colorFinish: Color;
      /**
      ...
      alpha: number;
      /**
       * The alpha of each particle at the start of its life. If not explicitly set, the 
       *     alpha value is used.
       */
      alphaStart: number;
      /**
       * The alpha of each particle at the end of its life. If not explicitly set, the 
       *     alpha value is used.
       */
      alphaFinish: number;
      /**
...
Entities.setLocalJointTranslations at the same time.
   ...
   * @param parentID {Uuid}  The ID of the entity to get the children IDs of.
   * @returns {Array.<Uuid>} 
   */
...
declare namespace TextureCache {
   ...
   * @returns {Resource} 
   */
  function prefetch(url: string, type: number, maxNumPixels: number): Resource;
  /**
   * Total number of total resources. Read-only.
   */
  let numTotal: number;
...
declare namespace Camera {
  ...
  let position: Vec3;
  /**
   * The orientation of the camera. You can set this value only when the camera is in independent
   *     mode.
   */
  let orientation: Quat;
  /**
  ...
  /**
   * The ID of the entity that is used for the camera position and orientation when the camera
   *     is in entity mode.
   */
