...
(function() {
    ...
    function onWebEventReceived(event) {
        print("ROC_Arena_Creator.js received a web event:" + event);
    ...
    function createEquipAreas() {
        ...
        var resetAreaProperties = {
            ...
            name: "ROC-Reset_Area",
            shapeType: "sphere",
            "serverScripts": Script.resolvePath("./ROC_Equipment_Creator.js") + "?" + Date.now()
        };
        ...
        var swordProperties1 = {
            ...
            shapeType: "compound",
            script: Script.resolvePath("./ROC_Battle_Simulator.js") + "?" + Date.now()
        };
        ...
        var signProperties = {
            ...
            script: Script.resolvePath("./ROC_Arena_Resetter.js") + "?" + Date.now(),
            "serverScripts": Script.resolvePath("./ROC_Blank.js") + "?" + Date.now()
        };
        ...
        var tabletBlueKnightifierProperties = {
            ...
            shapeType: "compound",
            script: Script.resolvePath("./ROC_Tablet_Opener.js") + "?" + Date.now()
        };
