...
(function() {
    ...
    _this.onReceivedMessage = function(channel, message, senderID) {
        ...
        } else if ((channel == gameChannel) && (MyAvatar.sessionUUID == equipData[5])) {
    ...
    _this.collisionWithEntity = function(myID, otherID, collisionInfo) {
        ...
        if ((enemyShield == otherID) && firstHit) {
            firstHit = false;
            //play collide sound
            Audio.playSound(blockSound, { loop: false, position: MyAvatar.position, volume: .2 });
            ...
            var usability = {
                "collidesWith": "",
                textures: '{ "normal": "https://hifi-content.s3.amazonaws.com/jedon/Game_Creater_Toolkit/ROC/SwordGameAssets/broadsword_01.fbx/broadsword_01.fbm/color-atlas-1b.jpg"}'
            };
            Entities.editEntity(myID, usability);
        ...
        //if the sword hits the enemy players body then I do damage. firstHit is used to control collision speed.
            ...
            firstHit = false;
            //play collide sound
            Audio.playSound(hitSound, { loop: false, position: MyAvatar.position, volume: .2 });
            ...
            if (health == 0) {
                ...
                Entities.deleteEntity(focalPoint);
                Entities.deleteEntity(enemyHearts[health]);
                ...
                Entities.editEntity(sword, replace);
                ...
                Entities.editEntity(enemySword, replace);

                //change texture on shield to show health has been lowered
                var heartsLeft = Script.resolvePath("./SwordGameAssets/shield_02.fbx") + "/shield_02.fbm/health-" + health + ".png";
                var lifeLeft = {
                        textures: '{ "health-5": "' + heartsLeft + '"}'
                    };
                Entities.editEntity(enemyShield, lifeLeft);
            } else {
    ...
    function Wait() {
        var usability = {
            "collidesWith": "static",
            textures: '{ "normal": "https://hifi-content.s3.amazonaws.com/jedon/Game_Creater_Toolkit/ROC/SwordGameAssets/broadsword_01.fbx/broadsword_01.fbm/color-atlas-1.jpg"}'
        };
        Entities.editEntity(sword, usability);
        firstHit = true;
    }
