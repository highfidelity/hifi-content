...
(function() {
    ...
    Turret.prototype = {
        preload: function(entityID) {
            ...
            // spawn turn table if it doesn't exist
            if (turretTurntable == "") {
        ...
        onUpdate: function(deltaTime) {
            ...
            // If we the turret has a target: rotate towards it
            if (currentTarget != null) {
        ...
        createBullet: function(){
            var bullet = Entities.addEntity({
                ...
                velocity: Vec3.multiply(
                    -bulletVelocity, 
                    Quat.getFront(Entities.getEntityProperties(_this.entityID, 'rotation').rotation)
                ),
            ...
            // Loading particle from JSON, some properties are not loaded up correctly
            //var created = [];
            ...
            //}
            shotParticle = Entities.addEntity(tempShotParticleProps);
            var props = {
                position: _this.getTurretParticleTipPosition(Entities.getEntityProperties(_this.entityID)),
                parentID: _this.entityID,
                textures: CONTENT_PATH + "/assets/shot/shot" + getRandomInt(1, 4) + ".png"
            };
