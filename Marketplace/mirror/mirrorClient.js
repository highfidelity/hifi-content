...
//  Edited by Caitlyn Meeks on 10/16/18 
//  Edited by Liv Erickson on 12/11/18
...
(function () { // BEGIN LOCAL SCOPE
    ...
    var _this = this;
    var RESOLUTION = 2048;          // The resolution of the mirror when turned on
    ...
    _this.preload = function(entityID) {
        ...
        // Uncomment the below block of code if you are using a zone to trigger the mirror behavior, and instead of
        // having a button as the child of the mirror, make the zone the child of the mirror.
