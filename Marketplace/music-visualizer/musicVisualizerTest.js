...
var TRAIL_SCRIPT = Script.resolvePath("adjuster_scripts/effectTrailer.js?" + Date.now());
    ...
    function createParticle(effectName, micSync, behavior, file) {
        ...
        if (behavior === "finger") {
            ...
            Script.setTimeout(function() {
                ...
                var effectLeftProps = Entities.getEntityProperties(effectLeft, "script", "userData");
                var effectRightProps = Entities.getEntityProperties(effectRight, "script", "userData");
                //effectLeftProps.script = TRAIL_LEFT_SCRIPT;
                //effectRightProps.script = TRAIL_RIGHT_SCRIPT;
                effectLeftProps.script = TRAIL_SCRIPT;
                effectRightProps.script = TRAIL_SCRIPT;
