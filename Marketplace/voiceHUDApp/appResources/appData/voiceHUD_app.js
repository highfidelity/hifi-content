...
(function(){
    ...
    function sortData() {
        var avatarList = Object.keys(userStore);
        settings.users = avatarList.map(function (uuid) { 
            return userStore[uuid]; 
        });
    }
    

    // This function create a HUD element over a user's head 
    ...
    // This function removes a user from the settings.user list
