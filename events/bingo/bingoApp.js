...
(function() {
    ...
    startup();
    // ------------------------NOT SURE WE SHOULD HAVE THIS HERE AT ALL 
    // -----------------------IF BOSS RELOADS APP, EVERYONE LOSES CARDS?
    // var CLICK_TO_PLAY_SIGN = "{da06f58c-e5b9-4105-8fe3-39949eb02279}";
    // Entities.callEntityMethod(CLICK_TO_PLAY_SIGN, 'removeCards');
}());
