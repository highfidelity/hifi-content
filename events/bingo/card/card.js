...
(function() {
    ...
    /* CREATE A BINGO CARD: A card consists of 5 columns corresponding to the letters in the word 'BINGO' and 5 rows 
    in each column. The center space, Column 3, Row 3, is a free space and will not be assigned a number. This function 
    fills each column with random numbers and then stores the numbers with the user's name in a google sheet for future 
    reference. */
    function createCard() {
        userCardNumbers = [];
        rowMinimum = 1;
    ...
    function onWebEventReceived(event) {
        ...
        if (event.type === 'calledBingo') {
            ...
            confettiParticle = Entities.addEntity({
                ...
                type: "ParticleEffect",
                serverScripts: Script.resolvePath("../particleServer.js"),
                userData: "{\"grabbableKey\":{\"grabbable\":false}}"
            }, true);
            Script.setTimeout(function() {
