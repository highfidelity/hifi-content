...
(function() {
    ...
    this.checkAnswer = function(id, params){
        ...
        switch (params[0]) {
            case 'Blue':
                scriptURL = Script.resolvePath('../Entity Scripts/triviaColorCheckBlue.js');
                break;
            case 'Green':
                scriptURL = Script.resolvePath('../Entity Scripts/triviaColorCheckGreen.js');
                break;
            case 'Yellow':
                scriptURL = Script.resolvePath('../Entity Scripts/triviaColorCheckYellow.js');
                break;
            case 'Red':
                scriptURL = Script.resolvePath('../Entity Scripts/triviaColorCheckRed.js');
                break;
        }
