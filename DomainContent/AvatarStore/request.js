...
// This file was imported here to prevent the cross-domain origin error:
// Error: Cannot find module 'request' (path 'file:///LocalInstallPath/scripts/modules/' outside of origin script 'URL'
// Keep this file in sync with https://github.com/highfidelity/hifi/blob/master/scripts/modules/request.js

// TODO: should we make an exception for the modules folder? (Thoys Jan-10-2018)
