...
(function () {
    ...
    var BASE_NAME = "HappyKiosk_",
        ...
        kioskButtonModel1 = baseURLButtons + "button-1.fbx",
        kioskButtonModel2 = baseURLButtons + "button-2.fbx",
        kioskButtonModel3 = baseURLButtons + "button-3.fbx",
        kioskButtonModel4 = baseURLButtons + "button-4.fbx",
        button1OnTexture = baseURLButtons + "button-1.fbx/button-1.fbm/button1-on.jpg",
        button1OffTexture = baseURLButtons + "button-1.fbx/button-1.fbm/button1-off.jpg",
        button2OnTexture = baseURLButtons + "button-2.fbx/button-2.fbm/button2-on.jpg",
        button2OffTexture = baseURLButtons + "button-2.fbx/button-2.fbm/button2-off.jpg",
        button3OnTexture = baseURLButtons + "button-3.fbx/button-3.fbm/button3-on.jpg",
        button3OffTexture = baseURLButtons + "button-3.fbx/button-3.fbm/button3-off.jpg",
        button4OnTexture = baseURLButtons + "button-4.fbx/button-4.fbm/button4-on.jpg",
        button4OffTexture = baseURLButtons + "button-4.fbx/button-4.fbm/button4-off.jpg",
