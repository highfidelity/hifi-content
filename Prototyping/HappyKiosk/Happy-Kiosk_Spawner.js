...
(function () {
    ...
    var BASE_NAME = "HappyKiosk_",
        ...
        kioskButtonModel1 = baseURL + "Models/button-1.fbx",
        kioskButtonModel2 = baseURL + "Models/button-2.fbx",
        kioskButtonModel3 = baseURL + "Models/button-3.fbx",
        kioskButtonModel4 = baseURL + "Models/button-4.fbx",
        kioskFeetModel = baseURL + "Models/footprint-standpoint.fbx",
        button1OnTexture = baseURL + "Models/button-1.fbx/button-1.fbm/button1-on.jpg",
        button1OffTexture = baseURL + "Models/button-1.fbx/button-1.fbm/button1-off.jpg",
        button2OnTexture = baseURL + "Models/button-2.fbx/button-2.fbm/button2-on.jpg",
        button2OffTexture = baseURL + "Models/button-2.fbx/button-2.fbm/button2-off.jpg",
        button3OnTexture = baseURL + "Models/button-3.fbx/button-3.fbm/button3-on.jpg",
        button3OffTexture = baseURL + "Models/button-3.fbx/button-3.fbm/button3-off.jpg",
        button4OnTexture = baseURL + "Models/button-4.fbx/button-4.fbm/button4-on.jpg",
        button4OffTexture = baseURL + "Models/button-4.fbx/button-4.fbm/button4-off.jpg",
